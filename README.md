...
**Day 1: Introduction to SQL & SELECT**
...
**Day 14: LEFT/RIGHT JOIN**

**Day 15: Multiple Joins**

**Mini Project: The Great Pizza (SQL Mini Project)**

**Days 16-18: Advanced Queries (Subqueries, UNION)**
**Day 16: Subqueries (WHERE)**

**Day 17: Subqueries (SELECT/FROM)**

**Day 18: UNION / UNION ALL**

**Days 19-20: Analytical (Window) Functions**
**Day 19: ROW_NUMBER(), RANK(), DENSE_RANK()**

**Day 20: Aggregate Window Functions**

**Day 21: CTEs (WITH clause)**
...
**🙏 Acknowledgements**
Thanks to **Indian Data Club (IDC) and DPDzero** for organizing this challenge.
